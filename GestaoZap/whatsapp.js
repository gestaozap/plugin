...
function addSellButton(){
  ...
  startBtnDiv.innerHTML = '<div class="titleText">Venda</div>';
...
function addActivateBtn() {
  ...
  console.log(body);
  var startBtnDiv = document.createElement("div");
  startBtnDiv.innerHTML = '<div class="titleText">Historico</div>';
